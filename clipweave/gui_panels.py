...
class OptionsPanel(QGroupBox):
    ...
    def _populate(self) -> None:
        ...
        self.option_cells["save_manifest"] = add_option(self.option_grid, 16, "Manifest", self.save_manifest_check, "Write a JSON manifest next to the output video.")
        self.option_cells["save_contact_sheet"] = add_option(self.option_grid, 17, "Contact sheet", self.save_contact_sheet_check, "Write one debug image with selected source frames.")
        self.option_cells["keep_work"] = add_option(self.option_grid, 18, "Temporary files", self.keep_work_check, "Keep intermediate render files for debugging.")
