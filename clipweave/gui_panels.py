...
class OptionsPanel(QGroupBox):
    ...
    def _populate(self) -> None:
        ...
        self.option_cells["auto_grade"] = add_option(self.option_grid, 16, "Auto grade", self.auto_grade_check, "Lightly normalize brightness, contrast, and saturation during render.")
        self.option_cells["smart_editing"] = add_option(self.option_grid, 17, "Smart editing", self.smart_editing_check, "Trim or skip clips that mostly repeat earlier sampled frames.")
        self.option_cells["smart_dedupe_segments"] = add_option(self.option_grid, 18, "Dedupe smart segments", self.smart_dedupe_segments_check, "Run a second visual duplicate pass after trimming.")
        self.option_cells["smart_reorder_segments"] = add_option(self.option_grid, 19, "Reorder smart segments", self.smart_reorder_segments_check, "Sort salvaged segments visually after smart editing.")
        self.option_cells["save_manifest"] = add_option(self.option_grid, 20, "Manifest", self.save_manifest_check, "Write a JSON manifest next to the output video.")
        self.option_cells["save_contact_sheet"] = add_option(self.option_grid, 21, "Contact sheet", self.save_contact_sheet_check, "Write one debug image with selected source frames.")
        self.option_cells["keep_work"] = add_option(self.option_grid, 22, "Temporary files", self.keep_work_check, "Keep intermediate render files for debugging.")
