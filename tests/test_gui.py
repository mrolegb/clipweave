...
class GuiTests(unittest.TestCase):
    ...
    def test_build_options_reads_current_fields(self) -> None:
        ...
        self.window.structure_combo.setCurrentText("arc")
        self.window.split_aspects_check.setChecked(True)
        self.window.exclude_manifest_history_check.setChecked(True)
        self.window.auto_grade_check.setChecked(True)
        self.window.keep_audio_check.setChecked(True)
        self.window.smart_editing_check.setChecked(True)
